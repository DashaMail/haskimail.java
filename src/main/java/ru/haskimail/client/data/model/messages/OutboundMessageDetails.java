...
public class OutboundMessageDetails extends OutboundMessage {
    ...
    public List<OutboundMessageDetailsEvents> getMessageEvents() { return messageEvents; }
    public void setMessageEvents(List<OutboundMessageDetailsEvents> messageEvents) { this.messageEvents = messageEvents; }
}
